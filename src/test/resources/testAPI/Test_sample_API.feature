...
Feature: Prueba de API
  ...
  Scenario Outline: Se realiza una consulta a una API sin certificado
		...
		And tengo el path de la api <api> de autorizacion
		When indico los datos para <usuario> y <clave> del body de autorizacion
		Then obtengo el codigo <codigo> como respuesta para autorizacion
    Examples: 
